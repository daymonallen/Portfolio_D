...
"# Portfolio_D"  git init git add README.md git commit -m "first commit" git remote add origin https://github.com/daymonallen/Portfolio_D.git git push -u origin master
